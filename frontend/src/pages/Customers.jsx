                                    ...
                                    <td className="px-10 py-8">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex flex-col min-w-0">
                                                <span className="font-black text-[#1A202C] text-[15px] tracking-tight group-hover:text-blue-600 transition-colors truncate">{item.name}</span>
                                                <span className="text-[10px] text-blue-500 font-black flex items-center gap-2 mt-1.5 hover:underline cursor-pointer uppercase tracking-widest opacity-80">
                                                    <FiGlobe size={11} strokeWidth={3} /> {item.website || "No terminal link"}
                                                </span>
                                            </div>
                                        </div>
                                    </td>
                ...
                {!loading && data.length === 0 && (
                    <div className="py-48 flex flex-col items-center gap-8 text-center bg-slate-50/20">
                        ...
                        <div className="space-y-3">
                            <p className="text-[13px] font-black text-[#1A202C] uppercase tracking-[0.3em]">Vault Terminal</p>
                            <p className="text-[#A0AEC0] text-sm font-bold max-w-xs mx-auto leading-relaxed">No customer telemetry detected in your primary infrastructure.</p>
                        </div>
                    </div>
                )}
            </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-10 space-y-8 max-h-[70vh] overflow-y-auto custom-scrollbar relative z-10">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-3 md:col-span-2">
                                    <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Entity Legal Identity</label>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input type="email" placeholder="contact@vault.com" className="w-full pl-16 pr-8 py-5 bg-[#F4F7FB] border border-transparent rounded-[24px] outline-none focus:bg-white focus:ring-4 focus:ring-blue-500/5 focus:border-blue-300 transition-all font-black text-[#1A202C] text-sm shadow-sm placeholder-[#CBD5E0]" value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} />
                                    </div>
                                </div>

                                <div className="space-y-3">
                                    <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Direct Command Phone</label>
                                    <div className="relative group">
                                ...
                                <div className="space-y-3">
                                    <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Public Record Link</label>
                                    <div className="relative group">
                                        ...
                                        <input placeholder="https://domain.com" className="w-full pl-16 pr-8 py-5 bg-[#F4F7FB] border border-transparent rounded-[24px] outline-none focus:bg-white focus:ring-4 focus:ring-blue-500/5 focus:border-blue-300 transition-all font-black text-[#1A202C] text-sm shadow-sm placeholder-[#CBD5E0]" value={formData.website} onChange={e => setFormData({ ...formData, website: e.target.value })} />
                                    </div>
                                </div>

                                <div className="space-y-3">
                                    <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Sector Vertical</label>
                                    <div className="relative group">
                                        <FiTarget size={18} className="absolute left-6 top-1/2 -translate-y-1/2 text-[#CBD5E0] group-focus-within:text-blue-600 transition-colors z-10" />
