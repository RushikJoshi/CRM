    ...
    if (fetching) {
        return (
            <div className="flex flex-col items-center justify-center h-[60vh] space-y-6">
                ...
                <p className="text-[#A0AEC0] font-black uppercase tracking-[0.3em] text-[11px]">Compiling Transition Data...</p>
            </div>
        );
    }
    ...
    if (!inquiry) {
        return (
            <div className="w-full mx-auto text-center py-32 space-y-8 animate-in zoom-in duration-500">
                ...
                <div>
                    <h2 className="text-3xl font-black text-[#1A202C] tracking-tighter">Null Data Reference</h2>
                    <p className="text-[#A0AEC0] font-black uppercase tracking-[0.2em] text-[11px] mt-2">The requested inquiry node is inaccessible or purged.</p>
                </div>
                ...
                <div className="flex items-center gap-6 relative z-10">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] font-black text-[#A0AEC0] uppercase tracking-[0.25em] opacity-80">
                            Transitioning inquiry telemetry to lead pipeline phase
                        </p>
                    </div>
                </div>
            </div>

            <div className="bg-white rounded-[40px] border border-[#E5EAF2] shadow-sm overflow-hidden max-w-4xl mx-auto">
                <div className="p-12 space-y-10">
                    ...
                    <div className="p-8 bg-blue-50/30 border border-blue-100 rounded-[32px] space-y-5 relative group">
                        ...
                        <div className="flex items-center justify-between border-b border-blue-100 pb-4">
                            <span className="text-[11px] font-black text-blue-600 uppercase tracking-[0.25em] flex items-center gap-2">
                                <span className="w-2 h-2 rounded-full bg-blue-500 animate-pulse" /> Source Persona
                            </span>
                        ...
                        <div className="text-[13px] font-black text-[#718096] italic leading-relaxed py-2">
                            "{inquiry.message || "No message payload detected."}"
                        </div>
                    </div>
                    ...
                    <div className="p-6 bg-[#F4F7FB] border border-[#E5EAF2] rounded-[24px] flex gap-5">
                        ...
                        <div className="space-y-1">
                            <p className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em]">Sequence Protocols</p>
                            <p className="text-[12px] text-[#718096] font-bold leading-relaxed">
                                Executing this transition will architect a new Lead record. The source inquiry node will be permanently archived as 'Converted'.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Node Principal Allocation</label>
                        <div className="relative group">
                            ...
                            >
                                <option value="">Automated Distribution / Vector Neutral</option>
                                <option value={currentUser.id || currentUser._id}>Assign to Current Operator (Self)</option>
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 pt-6 border-t border-[#F4F7FB]">
                        ...
                        <button onClick={handleConvert} disabled={loading}
                            ...
                            {loading ? (
                                ...
                                <><FiCheck size={20} strokeWidth={4} /> Finalize Conversion</>
                            )}
                        </button>
                    </div>
                </div>
