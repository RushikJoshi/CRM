    ...
    if (fetching) {
        return (
            <div className="flex flex-col items-center justify-center h-[60vh] space-y-6">
                ...
                <p className="text-[#A0AEC0] font-black uppercase tracking-[0.3em] text-[11px]">Syncing Persona Intel...</p>
            </div>
        );
    }
                ...
                <div className="flex items-center gap-6 relative z-10">
                    ...
                    <div>
                        <h1 className="text-4xl font-black text-[#1A202C] tracking-tighter leading-none mb-2">
                            {isEdit ? "Sync Persona Specs" : "Onboard Identity"}
                        </h1>
                        <p className="text-[11px] font-black text-[#A0AEC0] uppercase tracking-[0.25em] opacity-80">
                            {isEdit ? "Contact node optimization and association sync" : "Initialization of a new human stakeholder node"}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-8 max-w-5xl mx-auto">
                ...
                <div className="bg-white rounded-[40px] border border-[#E5EAF2] shadow-sm p-12 space-y-10 relative overflow-hidden">
                    <h2 className="text-[11px] font-black text-[#A0AEC0] uppercase tracking-[0.35em] flex items-center gap-3 mb-2">
                        <div className="w-2 h-2 rounded-full bg-blue-500" /> Identity Matrix Information
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3 md:col-span-2">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Full Legal Identity *</label>
                            <div className="relative group">
                                ...
                                <input name="name" className={inputCls("name")} placeholder="Full Persona Name..."
                        ...
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Cloud Comm Link</label>
                            <div className="relative group">
                                ...
                                <input name="email" className={inputCls("email")} placeholder="persona@cloud.io"
                        ...
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Secure Voice Line</label>
                            <div className="relative group">
                                ...
                                <input name="phone" className={inputCls("phone")} placeholder="Dial Telemetry..."
                ...
                <div className="bg-white rounded-[40px] border border-[#E5EAF2] shadow-sm p-12 space-y-10 relative overflow-hidden">
                    <h2 className="text-[11px] font-black text-[#A0AEC0] uppercase tracking-[0.35em] flex items-center gap-3 mb-2">
                        <div className="w-2 h-2 rounded-full bg-blue-500" /> Operational Association Matrix
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3 md:col-span-2">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Parent Customer Node *</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Department Segment</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Strategic Buying Role</label>
                            <div className="relative group">
                                <FiSettings size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-[#CBD5E0] group-focus-within:text-blue-600 transition-colors" />
                ...
                <div className="flex flex-col sm:flex-row gap-6 pt-4">
                    ...
                    <button type="submit" disabled={loading}
                        ...
                        {loading ? (
                            ...
                            <><FiSave size={20} strokeWidth={3} /> {isEdit ? "Sync Persona Specs" : "Commit Persona Node"}</>
                        )}
                    </button>
                </div>
            </form>
