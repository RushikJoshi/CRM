    ...
    if (fetching) {
        return (
            <div className="flex flex-col items-center justify-center h-[60vh] space-y-6">
                ...
                <p className="text-[#A0AEC0] font-black uppercase tracking-[0.3em] text-[11px]">Syncing Entity Telemetry...</p>
            </div>
        );
    }
                ...
                <div className="flex items-center gap-6 relative z-10">
                    ...
                    <div>
                        <h1 className="text-4xl font-black text-[#1A202C] tracking-tighter leading-none mb-2">
                            {isEdit ? "Sync Entity Specs" : "Onboard Entity"}
                        </h1>
                        <p className="text-[11px] font-black text-[#A0AEC0] uppercase tracking-[0.25em] opacity-80">
                            {isEdit ? "Enterprise data synchronization and node optimization" : "Initialization of a new corporate network node"}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-8 max-w-5xl mx-auto">
                ...
                <div className="bg-white rounded-[40px] border border-[#E5EAF2] shadow-sm p-12 space-y-10 relative overflow-hidden">
                    <h2 className="text-[11px] font-black text-[#A0AEC0] uppercase tracking-[0.35em] flex items-center gap-3 mb-2">
                        <div className="w-2 h-2 rounded-full bg-blue-500" /> Entity Matrix Information
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative group">
                                ...
                                <input name="name" type="text" placeholder="Corporate Name..."
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative group">
                                ...
                                <input name="email" type="email" placeholder="corp@network.io"
                        ...
                        {/* Phone */}
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Secure Line</label>
                            <div className="relative group">
                                ...
                                <input name="phone" type="tel" placeholder="Dial Code..."
                        ...
                        {/* Website */}
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Digital Domain</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-3 md:col-span-2">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Market Sector</label>
                            <div className="relative group">
                        ...
                        {/* Address */}
                        <div className="space-y-3 md:col-span-2">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Global HQ Position</label>
                            <div className="relative group">
                                <FiMapPin size={20} className="absolute left-5 top-6 text-[#CBD5E0] group-focus-within:text-blue-600 transition-colors" />
                                <textarea name="address" rows={3} placeholder="Full spatial address telemetry..."
                ...
                {!isEdit && (
                    <div className="bg-white rounded-[40px] border border-[#E5EAF2] shadow-sm p-12 space-y-10 relative overflow-hidden">
                        <h2 className="text-[11px] font-black text-[#A0AEC0] uppercase tracking-[0.35em] flex items-center gap-3 mb-2">
                            <FiShield size={20} strokeWidth={2.5} className="text-blue-600" /> Admin Node Provisioning
                        </h2>
                        ...
                        <div className="p-6 bg-blue-50/50 border border-blue-100 rounded-[24px] flex items-start gap-4">
                            ...
                            <p className="text-[12px] font-black text-blue-900/70 leading-relaxed uppercase tracking-wide">
                                Initialization of the Root Administrative Node. Credentials must be transmitted via secure channels only.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-3">
                                <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">
                                    Root Admin Identity <span className="text-red-500">*</span>
                                </label>
                                <div className="relative group">
                                    ...
                                    <input name="adminName" type="text" placeholder="Full Identity Name..."
                            ...
                            <div className="space-y-3">
                                <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">
                                    Auth Link (Email) <span className="text-red-500">*</span>
                                </label>
                                <div className="relative group">
                                    <FiMail size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-[#CBD5E0] group-focus-within:text-blue-600 transition-colors" />
                                    <input name="adminEmail" type="email" placeholder="admin@domain.io"
                            ...
                            <div className="space-y-3 md:col-span-2">
                                <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">
                                    Root Access Key <span className="text-red-500">*</span>
                                </label>
                                <div className="relative group">
                                    ...
                                    <input name="adminPassword" type="password" placeholder="Entropy min 8 characters..."
                ...
                <div className="flex flex-col sm:flex-row gap-6 pt-4">
                    ...
                    <button type="submit" disabled={loading}
                        ...
                        {loading ? (
                            ...
                            <><FiSave size={20} strokeWidth={3} /> {isEdit ? "Sync Entity Specs" : "Commit Entity Node"}</>
                        )}
                    </button>
                </div>
            </form>
