        ...
        <div className="w-full space-y-10 pb-24 animate-in fade-in duration-1000">
            ...
            <div className="bg-white rounded-[32px] border border-[#E5EAF2] shadow-sm p-10 relative overflow-hidden group">
                ...
                <div className="flex items-center gap-6 relative z-10">
                    ...
                    <div>
                        <h1 className="text-4xl font-black text-[#1A202C] tracking-tighter leading-none mb-2">Ingest Inquiry</h1>
                        <p className="text-[11px] font-black text-[#A0AEC0] uppercase tracking-[0.25em] opacity-80">
                            Telemetry record initialization for manual ingestion
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-8 max-w-5xl mx-auto">
                <div className="bg-white rounded-[40px] border border-[#E5EAF2] shadow-sm p-12 space-y-10 relative overflow-hidden">
                    <h2 className="text-[11px] font-black text-[#A0AEC0] uppercase tracking-[0.35em] flex items-center gap-3 mb-2">
                        <div className="w-2 h-2 rounded-full bg-blue-500" /> Source Intelligence & Profile
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Full Identity Profile *</label>
                        ...
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Cloud Communication Link *</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Direct Command Number *</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Potential Revenue Stream</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Occupational Status</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Curriculum Intent</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Discovery Attribution</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Operating Zone</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">City Jurisdiction *</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-3 md:col-span-2">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Spatial Address Telemetry *</label>
                            <div className="relative group">
                                ...
                                <textarea name="address" rows={3} className={inputCls("address").replace("pl-14", "pl-14 py-6") + " resize-none"}
                                    placeholder="Enter exhaustive address telemetry *" value={formData.address} onChange={handleChange} />
                            </div>
                        </div>

                        <div className="space-y-3 md:col-span-2">
                            <label className="text-[11px] font-black text-[#1A202C] uppercase tracking-[0.15em] ml-2">Supplemental Intelligence Request</label>
                            <div className="relative group">
                                ...
                                <textarea name="message" rows={3} className={inputCls("message").replace("pl-14", "pl-14 py-6") + " resize-none"}
                                    placeholder="Append queries or logic context..." value={formData.message} onChange={handleChange} />
                            </div>
                        </div>

                        {isCompanyAdmin && (
                            <div className="space-y-3 md:col-span-2">
                                <label className="text-[11px] font-black text-blue-600 uppercase tracking-[0.2em] ml-2">Allocation Branch (Administrative Only)</label>
                                <div className="relative group">
                ...
                <div className="flex flex-col sm:flex-row gap-6 pt-4">
                    ...
                    <button type="submit" disabled={loading}
                        ...
                        {loading ? (
                            ...
                            <><FiSave size={20} strokeWidth={3} /> Commit Inquiry Record</>
                        )}
                    </button>
                </div>
            </form>
