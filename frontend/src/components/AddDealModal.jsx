        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-slate-900/60 backdrop-blur-md animate-in fade-in duration-300">
            <div className="bg-white w-full max-w-2xl rounded-[40px] shadow-2xl border border-[#E5EAF2] overflow-hidden animate-in zoom-in-95 duration-500 relative">
                ...
                <div className="px-10 py-10 bg-white flex flex-col items-center justify-center border-b border-[#F0F2F5] relative z-10 text-center">
                    ...
                    <div className="w-16 h-16 bg-blue-600 text-white rounded-[22px] flex items-center justify-center shadow-2xl shadow-blue-500/30 transform -rotate-3 mb-6">
                ...
                <form onSubmit={handleFormSubmit} className="p-10 space-y-8 max-h-[70vh] overflow-y-auto custom-scrollbar relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-6">
                            ...
                            <div className="relative group">
                                <span className="absolute left-5 top-1/2 -translate-y-1/2 text-[#CBD5E0] font-black group-focus-within:text-blue-600 transition-colors">₹</span>
                            ...
                            <div className="relative group">
                                <FiTarget size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-[#CBD5E0] group-focus-within:text-blue-600 transition-colors z-10" />
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="relative group">
                                <FiBriefcase size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-[#CBD5E0] group-focus-within:text-blue-600 transition-colors z-10" />
                            ...
                            <div className="relative group">
                                <FiFlag size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-[#CBD5E0] group-focus-within:text-blue-600 transition-colors z-10" />
                            ...
                            <div className="relative group">
                                <FiUser size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-[#CBD5E0] group-focus-within:text-blue-600 transition-colors z-10" />
                    ...
                    <div className="pt-10 flex flex-col sm:flex-row gap-6 border-t border-[#F4F7FB]">
                        ...
                        <button type="submit" className="flex-[2] py-5 bg-blue-600 text-white font-black rounded-[24px] hover:bg-blue-700 hover:scale-[1.02] active:scale-95 transition-all text-[11px] uppercase tracking-[0.25em] shadow-2xl shadow-blue-600/20 duration-300">
                            Commit Acquisition
                        </button>
                    </div>
                </form>
