...
exports.createCall = async (req, res) => {
    try {
        ...
        // Log activity on related records
        ...
        await Activity.create({
            ...
            companyId: req.user.companyId,
            type: "call",
            note: `Call logged: ${data.title || "Call"}`
        });
...
exports.getMeetings = meetingController.getMeetings;
exports.updateMeeting = meetingController.updateMeeting;
exports.deleteMeeting = meetingController.deleteMeeting;
...
exports.createTodo = async (req, res) => {
    try {
        ...
        // Log activity for generic TODOs
        const Activity = require("../models/Activity");
        await Activity.create({
            leadId: data.leadId || null,
            dealId: data.dealId || null,
...
exports.createNote = async (req, res) => {
    try {
        ...
        await Activity.create({
            ...
            companyId: req.user.companyId,
            type: "note",
            note: `Note added: ${data.title || (data.content ? data.content.substring(0, 50) + "..." : "Note")}`
        });
