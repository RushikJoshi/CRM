...
const { createUser, getUsers, getUserById, updateUser, deleteUser, getAssignableUsers, updatePublicKey, getDirectory } = require("../controllers/userController");

router.get("/assignable", auth, checkCompanyAccess, getAssignableUsers);
router.get("/directory", auth, getDirectory);
router.put("/me/public-key", auth, updatePublicKey);
