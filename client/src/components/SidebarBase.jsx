...
const SidebarBase = ({
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed lg:relative top-0 left-0 z-[70] h-full flex flex-col
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${isActive
                    ? "bg-[#0D9488] text-white font-semibold shadow-md"
                    : "text-gray-600 hover:bg-teal-50 hover:text-[#0D9488] font-medium"
                  }
