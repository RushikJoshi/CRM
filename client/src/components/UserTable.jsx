                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-slate-50 border-b border-[#F0F2F5] shadow-sm relative z-10">
                            <th className="px-4 sm:px-10 py-6 text-[10px] font-black text-[#A0AEC0] uppercase tracking-[.25em]">User Name</th>
                            <th className="px-4 sm:px-10 py-6 text-[10px] font-black text-[#A0AEC0] uppercase tracking-[.25em]">Role</th>
                            <th className="px-4 sm:px-10 py-6 text-[10px] font-black text-[#A0AEC0] uppercase tracking-[.25em]">Company / Branch</th>
                            <th className="px-4 sm:px-10 py-6 text-[10px] font-black text-[#A0AEC0] uppercase tracking-[.25em]">Status</th>
                            <th className="px-4 sm:px-10 py-6 text-[10px] font-black text-[#A0AEC0] uppercase tracking-[.25em] text-right">Actions</th>
                        </tr>
                    </thead>
